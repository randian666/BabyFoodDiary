...
enum FoodIconCatalog {
    ...
    static let icons: [Icon] = [Icon(id: "meal-bowl", name: "餐盘", category: "全部", aliases: ["餐", "菜", "饭", "粥", "泥", "饼"])]
        ...
        + group("肉蛋奶", "pork:猪肉,猪", "beef:牛肉,牛", "lamb:羊肉,羊", "chicken:鸡肉,鸡", "duck:鸭肉,鸭", "pigeon:鸽子,鸽", "liver:猪肝,鸡肝,肝", "egg:鸡蛋,蛋黄,蛋白,蒸蛋", "quail-egg:鹌鹑蛋", "milk:牛奶,鲜奶", "yogurt:酸奶", "cheese:奶酪,芝士", "butter:黄油")
